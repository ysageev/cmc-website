  ...
  return (
    <div id="historic" style={{ scrollMarginTop: 60 }}>
      <ServiceBanner
        ...
        divId="historic-content"
      />

      <div id="historic-content" className="collapse-div">
        <div className="service-content">
          <p>
            CMC offers complete assessment and tracking of Historic Preservation tax credit items
            for both the National Parks Service (NPS) and New York's State Historic Preservation
            Office (SHPO).
          </p>
          <p>
            We offer reports that cover both the application process and compliance during
            construction:{" "}
          </p>
