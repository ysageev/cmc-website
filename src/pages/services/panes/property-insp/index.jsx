				...
				<div className="service-content" style={{ width: "100%" }}>
					<div>
						...
						<p>
							...
							for replacements and improvements are imperative to maintaining an asset's value. Inadequate replacement reserve may result in substantial physical deterioration of
							the asset, which will in turn adversely affect its collateral value and significantly increase an investor's risk over term.
							<br />
							<br />
