      ...
      <div>
        ...
        <div id="portfolio-content" className="collapse-div">
          <div className="service-content">
            Most lenders find it difficult to understand their entire loan portfolio. They might
            understand specific projects well, but have trouble identifying:
            <br />
            <br />
            <ul>
              ...
              <li>
                How are projects progressing toward completion? When will monies be available for
                new projects and how much?
              </li>
              <li>
            ...
            <div style={{ clear: "both" }}>
              <p>
                ...
                <br />
                <br />
                Lenders can sign in and view all their projects handled by vendors who use{" "}
                <StructDBText />.
                <br />
                <br />
                <a
