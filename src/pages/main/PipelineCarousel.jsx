    ...
    <div className="page-section">
      ...
      >
        <PainPoint title="Overview" imageName="pipeline" cn="pos1">
          Pain points (red paths) associated with different assets and goals are resolved by CMC
          services and then flow into other CMC services.
          <br />
          <br />
        ...
        <PainPoint title="Existing Property" imageName="existing" cn="pos1">
          Existing properties can be kept as an asset or be intended for renovation. A frequent
          pain-point for asset owners is knowing the Expected Useful Life of asset components and
          knowing the future annual maintenance costs over term.
          <br />
          <br />
          For pre-renovation properties, lenders need to assess the condition of the property and
          it's proplems, prior to evaluating plans.
          <br />
          <br />
          Learn more about&nbsp;
        ...
        <PainPoint title="Historic Property" imageName="historic" cn="pos2">
          Historic properties require careful vetting during pre-construction of the National Parks
          Service (NPS) Part 1 application. During construction, projects require conformance
        ...
        <PainPoint title="Distressed Asset" imageName="distressed" cn="pos3">
          Occasionally, clients come to CMC with projects under construction that have encountered
          show-stopping problems. Owners or contractors may have "walked away", or unforeseen
        ...
        <PainPoint title="Proposed Project" imageName="proposed-project" cn="pos4">
          Proposed projects consist of New Builds and Renovations. CMC's Plan and Cost Report (PNC)
          addresses all the pain points necessary to vet a project for construction.
          <br />
          <br />
          Learn more about&nbsp;
        ...
        <PainPoint title="Under Construction" imageName="under-construction" cn="pos5">
          Once a loan has closed, construction may begin. Any pre-construction and plan & cost
          reports have been completed. At this point, site visit monitoring and reporting takes
        ...
        <PainPoint title="Loan Portfolio" imageName="portfolio" cn="pos6">
          Our loan portfolio dashboards track projects under construction, plan and cost materials
          status, closed projects, and provide aggregate charts to facilitate decision making.
          <br />
          <br />
          Learn more about&nbsp;
...
const PainPoint = ({ title, imageName, children, _cn }) => {
