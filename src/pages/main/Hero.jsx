    ...
    <div>
      <div className="page-header">
        <div className="hero-logos">
          ...
          <img src="img/eoc-new-min.png" alt="eyes-on-construction" className="eyes-on-img" />
        </div>
        <div className="page-header-text hero-header-text">Reduce Risk, Lend Confidently</div>

        <div className="page-header-details-text">
          For over 35 years, CMC has partnered with banks and investors in commercial construction
          lending to provide clarity and confidence.
          <br />
          <br />
          We empower our clients to effectively measure, assess, and mitigate construction loan
          risks.
        </div>
