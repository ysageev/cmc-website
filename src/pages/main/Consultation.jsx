...
const emailURL =
  "mailto:info@go-cmc.com?subject=CMC Consultation Request&body=Enter your information here";

const consult = (
  <div className="consultation-container">
    <Link className="button button--primary button--lg consultation-button" to={emailURL}>
